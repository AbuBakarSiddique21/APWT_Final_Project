                ...
                
                {
                    customer.map(a => (
                        <tr >
                            ...
                            <td><button className="buttonDetails4" onClick={() =>ActiveCustomer(a.id)} ><p>Active</p></button></td> 
                            <td><button className="buttonDetails5" onClick={() =>DeactiveCustomer(a.id)} ><p>Deactive</p></button></td>  
