                ...
                
                {
                    deliverymans.map(a => (
                        <tr >
                            ...
                            <td><Link className="buttonDetails2" to={"/edit/deliveryMan/" + a.id }><p>Edit</p></Link></td>
                            <td><button className="buttonDetails1" onClick={() =>deleteDeliveryman(a.id)} ><p>Delete</p></button></td>   
                        </tr>
                    ))
                }
            </table>
