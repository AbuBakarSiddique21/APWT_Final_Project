...

                {
                    products.map(p => (
                        <tr>
                            ...
                            <td><Link className="buttonDetails2" to={"/edit/product/" + p.id}><p>Edit</p></Link></td>
                            <td><button className="buttonDetails1" onClick={() => deleteProduct(p.id)} ><p>Delete</p></button></td>
                        </tr>
                    ))
                }
            </table>
